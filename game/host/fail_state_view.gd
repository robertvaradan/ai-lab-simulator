...
func _build() -> void:
	...
	add_child(center)
	var panel: Panel = CampaignChrome.make_panel("FailStatePanel")
	panel.custom_minimum_size = Vector2(560.0, 280.0)
	center.add_child(panel)
	var layout: VBoxContainer = CampaignChrome.make_column("FailStateLayout")
	...
	CampaignChrome.apply_body(_reason_label)
