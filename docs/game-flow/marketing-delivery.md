...
| production-slice | Build production presentation | LEAF | PARTIAL | - | YES | docs/marketing/marketing-slice.md | game/host/marketing_play_host.gd; game/scenes/marketing_play.tscn | game/tests/host/marketing_play_host_test.gd | The production host loads the Marketing Scenario. The representative management interface is not complete. |
