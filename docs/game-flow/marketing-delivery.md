...
| developer-inspection | Build developer inspection tools | LEAF | COMPLETE | - | YES | docs/tools/simulation-laboratory.md; docs/simulation/rule-graph.md | game/tools/simulation_lab/simulation_lab_session.gd; game/tools/rule_graph/rule_graph_artifact_compiler.gd; game/tools/rule_graph/rule_graph_trace_classifier.gd | game/tests/tools/simulation_lab_test.gd; game/tests/tools/rule_graph_artifact_test.gd; game/tests/tools/rule_graph_trace_view_test.gd | The minimal Simulation Laboratory, Rule Graph artifact, and Rule Graph trace view exist. |
| production-slice | Build production presentation | LEAF | COMPLETE | - | YES | docs/marketing/marketing-slice.md | game/host/marketing_play_host.gd; game/host/marketing_play_overlay.gd; game/host/campus_visual_presenter.gd; game/scenes/marketing_play.tscn | game/tests/host/marketing_play_management_test.gd; game/tests/host/campus_visual_presenter_test.gd | The production overlay can complete the Marketing Scenario first quarter. Campus visuals use Simulation Core state. |
