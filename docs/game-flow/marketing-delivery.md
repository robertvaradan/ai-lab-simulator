...
| simulation-skeleton | Build simulation walking skeleton | LEAF | PARTIAL | - | YES | docs/simulation/README.md; docs/implementation/marketing-slice-backlog.md | game/simulation/core/simulation_core.gd; game/simulation/content/marketing_scenario_factory.gd | - | Milestone 1 is complete through the Quarterly Report. |
| developer-inspection | Build developer inspection tools | LEAF | NONE | - | YES | docs/tools/simulation-laboratory.md; docs/simulation/rule-graph.md | - | - | The minimal laboratory and Rule Graph developer views do not exist. |
