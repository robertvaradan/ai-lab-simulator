...
| inspect | Inspect authoritative state | LEAF | PARTIAL | - | YES | docs/gameplay/core-loop.md; docs/simulation/state-and-ledger.md | game/simulation/state/game_state.gd; game/simulation/host/game_state_echo.gd; game/host/marketing_play_overlay.gd | game/tests/host/marketing_play_host_test.gd | Authoritative state exists, and the production overlay presents Month Step, Cash, Attention Events, and the Quarterly Report. |
...
| advance | Advance simulation time | LEAF | COMPLETE | - | YES | docs/gameplay/core-loop.md; docs/simulation/time-model.md; docs/simulation/invariants.md | game/simulation/core/simulation_core.gd; game/simulation/host/simulation_advance_action.gd; game/simulation/validation/simulation_invariant_checker.gd | game/tests/simulation/month_step_test.gd; game/tests/simulation/game_state_publication_test.gd; game/tests/simulation/invariants_replay_test.gd | Advance runs canonical Month Steps, checks Simulation Invariants, and stops at an attention boundary. |
| resolve | Resolve simulation results | LEAF | PARTIAL | - | YES | docs/gameplay/core-loop.md; docs/simulation/time-model.md | game/simulation/rules/resolve_project_completions_rule.gd; game/simulation/rules/advance_competitors_rule.gd; game/simulation/rules/post_operating_cost_rule.gd; game/simulation/rules/post_compute_contract_costs_rule.gd; game/simulation/rules/post_application_revenue_rule.gd; game/simulation/rules/create_quarter_boundary_attention_rule.gd; game/simulation/rules/create_quarterly_report_rule.gd | game/tests/simulation/quarterly_report_test.gd | Project, Competitor, Revenue, and Quarterly Report data exist, but the production game does not present them. |
| attention | Respond to Attention Events | LEAF | PARTIAL | - | YES | docs/gameplay/core-loop.md; docs/simulation/time-model.md | game/simulation/state/attention_event_response.gd; game/simulation/validation/attention_event_response_validator.gd; game/host/marketing_play_overlay.gd | game/tests/host/marketing_play_host_test.gd | The production overlay presents Attention Events and can acknowledge them in the next Plan. |
