...
| production-slice | Build production presentation | LEAF | PARTIAL | - | YES | docs/marketing/marketing-slice.md | game/host/marketing_play_host.gd; game/host/marketing_play_overlay.gd; game/scenes/marketing_play.tscn | - | The production overlay can complete the Marketing Scenario first quarter. Representative world-state visuals are not complete. |
