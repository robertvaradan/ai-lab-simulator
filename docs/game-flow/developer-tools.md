...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| tool-flow | Developer tool flow | BRANCH | DERIVED | - | YES | docs/tools/simulation-laboratory.md; docs/simulation/rule-graph.md; docs/tools/decision-host.md | - | - | Developer tools use the public Simulation Core and show exact simulation behavior. |
...
| decision-host | Decision Host | LEAF | COMPLETE | - | NO | docs/tools/decision-host.md | game/tools/decision_host/decision_host.gd; game/tools/decision_host/decision_host_view.gd; game/tools/decision_host/decision_host.tscn | game/tests/tools/decision_host_test.gd | The Decision Host presents registry Project controls and last-Advance inspect data without the campus. |
...
| tool-flow | decision-host | includes |
