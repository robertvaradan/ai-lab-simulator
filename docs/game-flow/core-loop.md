...
| inspect | Inspect authoritative state | LEAF | PARTIAL | - | YES | docs/gameplay/core-loop.md; docs/simulation/state-and-ledger.md | game/simulation/state/game_state.gd; game/simulation/host/game_state_echo.gd; game/host/marketing_play_overlay.gd | - | Authoritative state exists, and the production overlay presents Month Step, Cash, Attention Events, and the Quarterly Report. |
