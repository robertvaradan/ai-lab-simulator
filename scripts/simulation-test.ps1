...
Write-Output '[2/14] Running Game State and snapshot tests'
Invoke-SimulationTest -ScriptPath 'res://tests/simulation/game_state_test.gd' -SuccessMarker 'GAME_STATE_TEST_SUCCESS'

Write-Output '[3/14] Running committed Game State publication tests'
...
Write-Output '[9/14] Running Competitor forecast and release tests'
...
Write-Output '[12/14] Running Simulation Invariant and replay tests'
