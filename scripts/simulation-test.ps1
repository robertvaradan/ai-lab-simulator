...
Write-Output '[2/16] Running Game State and snapshot tests'
Invoke-SimulationTest -ScriptPath 'res://tests/simulation/game_state_test.gd' -SuccessMarker 'GAME_STATE_TEST_SUCCESS'

Write-Output '[3/16] Running committed Game State publication tests'
...
Write-Output '[9/16] Running Competitor forecast and release tests'
...
Write-Output '[12/16] Running Simulation Invariant and replay tests'
...
Write-Output '[15/16] Running Rule Graph trace view tests'
...
Write-Output '[16/16] Running production Marketing play host tests'
