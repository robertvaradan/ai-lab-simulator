...
| simulation-skeleton | Build simulation walking skeleton | LEAF | PARTIAL | - | YES | docs/simulation/README.md; docs/implementation/marketing-slice-backlog.md | game/simulation/core/simulation_core.gd; game/simulation/content/marketing_scenario_factory.gd | - | Milestone 1 is complete through the three Marketing Scenario Projects. |
