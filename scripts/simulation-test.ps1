...
Write-Output '[2/17] Running Game State and snapshot tests'
Invoke-SimulationTest -ScriptPath 'res://tests/simulation/game_state_test.gd' -SuccessMarker 'GAME_STATE_TEST_SUCCESS'

Write-Output '[3/17] Running committed Game State publication tests'
...
Write-Output '[9/17] Running Competitor forecast and release tests'
...
Write-Output '[12/17] Running Simulation Invariant and replay tests'
...
Write-Output '[15/17] Running Rule Graph trace view tests'
...
Write-Output '[16/17] Running production Marketing play host tests'
...
Write-Output '[17/17] Running production Marketing play management tests'
