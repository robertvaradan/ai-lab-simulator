...
| laboratory | Simulation Laboratory | LEAF | NONE | - | YES | docs/tools/simulation-laboratory.md | - | - | The laboratory directory has no executable implementation. |
| replay-tool | Save and replay a run | LEAF | NONE | - | YES | docs/tools/simulation-laboratory.md; docs/simulation/invariants.md | - | - | The developer replay workflow does not exist. |
