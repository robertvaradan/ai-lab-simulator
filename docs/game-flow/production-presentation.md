...
| simulation-connection | Connect production to Simulation Core | LEAF | NONE | - | YES | docs/gameplay/core-loop.md; docs/marketing/marketing-slice.md | - | - | The production scene does not load the Marketing Scenario or execute player Plans. |
