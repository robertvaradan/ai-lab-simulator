...
| resolve | Resolve simulation results | LEAF | PARTIAL | - | YES | docs/gameplay/core-loop.md; docs/simulation/time-model.md | game/simulation/rules/resolve_project_completions_rule.gd; game/simulation/rules/advance_competitors_rule.gd; game/simulation/rules/post_operating_cost_rule.gd; game/simulation/rules/post_compute_contract_costs_rule.gd; game/simulation/rules/post_application_revenue_rule.gd; game/simulation/rules/create_quarter_boundary_attention_rule.gd | - | Project, Competitor, and Revenue results exist, but the Quarterly Report does not exist. |
