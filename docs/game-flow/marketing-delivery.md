...
| developer-inspection | Build developer inspection tools | LEAF | PARTIAL | - | YES | docs/tools/simulation-laboratory.md; docs/simulation/rule-graph.md | game/tools/simulation_lab/simulation_lab_session.gd; game/tools/rule_graph/rule_graph_artifact_compiler.gd | game/tests/tools/simulation_lab_test.gd; game/tests/tools/rule_graph_artifact_test.gd | The minimal Simulation Laboratory and Rule Graph artifact exist. The Rule Graph trace view does not exist. |
