...
| skill-tree | Company skill tree | LEAF | PARTIAL | - | NO | docs/gameplay/progression.md; docs/gameplay/production-bootstrap.md | game/host/skill_tree_view.gd; game/host/campaign_catalog.gd | - | The production bootstrap presents a proof skill tree. The complete specialization tree does not exist. |
